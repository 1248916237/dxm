            ...
            <div class="layui-row">
                <form class="layui-form" >
                  <div class="layui-form-item">
                      ...
                      <input type="hidden" name="supplierId" value="${selSupById.supplierId }">
                          <input type="text" id="name" name="supplierName" required="" lay-verify="required" 
                          autocomplete="off" class="layui-input" value="${selSupById.supplierName }">
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="${selSupById.supplierAddress }">
                      </div>
                      <!-- <div class="layui-form-mid layui-word-aux">
                          <span class="x-red">*</span>将会成为您唯一的登入名
                      </div> -->
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="${selSupById.supplierKind }">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${selSupById.supplierPhone }">
                    </div>
                  </div>
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="${selSupById.supplierCard }">
                      </div>
                      <!-- <div class="layui-form-mid layui-word-aux">
                          6到16个字符
                      </div> -->
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="${selSupById.cardKind }">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label for="L_repass" class="layui-form-label">
